      ...
      <div className="row mt-5">
        <div className="col-12 col-md-7">
          <div className="row mx-3">
            <div className="row mx-3">
              <div className="col-12 col-md-10 mx-auto mx-3">
                <h3 className="text-light ">Getting Started Guide</h3>
                <p className="font-14">
                  We have gathered a bulky list of questions from our users and
                  provided the best answers to these.
                </p>
                ...
                {DATA.map((item, index) => (
                  ...
                  >
                    <div className="d-flex justify-content-between align-items-center">
                      <h5 className="text-lighter text-bold p-0 m-0">{item.title} </h5>
                      <div className="mr-2 text-bold cursor-pointer font-16"  onClick={() =>
                      setCardId(
        ...
        <div className="col-12 col-md-5 ">
          <form className="row ">
            <h3 className="text-light ">Our experts will help you</h3>
            <p className="font-14 ">
            ...
            <div className="col-12  form-group mb-3">
              <input
                ...
                required
                className="form-control text-center auth-input py-3"
              />
            </div>
